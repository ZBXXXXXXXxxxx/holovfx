	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				if( lerpResult26 > 0.03 )
				ifLocalVar40 = _Vector2.z;
				else if( lerpResult26 == 0.03 )
				...
				float3 Color = ( CLIP22 + ( ifLocalVar40 * _Color0 ) ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18800
-128.8;624;1442.4;733.4;392.2135;-121.5595;1;True;False
...
Node;AmplifyShaderEditor.Vector3Node;15;-2589.158,304.9399;Inherit;False;Global;SSS;SSS;3;0;Create;True;0;0;0;False;0;False;0,0,0;0.010088,0.010088,0.010088;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SamplerNode;3;-1549.307,-329.705;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;52;-116.7933,1054.961;Inherit;False;Constant;_Float4;Float 4;6;0;Create;True;0;0;0;False;0;False;987.7;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;11;-2593.637,114.761;Inherit;False;Global;PPP;PPP;3;0;Create;True;0;0;0;False;0;False;0,0,0;0.013,0.0181,-0.0066;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
WireConnection;40;4;42;1
WireConnection;37;0;23;0
WireConnection;37;1;38;0
WireConnection;68;2;37;0
ASEEND*/
//CHKSM=B481E44F64F1009DB94A143B80C7C527EADF409B